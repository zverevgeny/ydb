...
NTxUT::TPlanStep PrepareTablet(
    TTestBasicRuntime& runtime, const ui64 tableId, const std::vector<NArrow::NTest::TTestColumn>& schema, const ui32 keySize, bool inStore) {
    using namespace NTxUT;
    ...
    tableDescription.InStore = inStore;
    tableDescription.Pk = {};
